...
public class AppSettingsDialog {
    ...
    private static Pane unitSettings(AppSettings settings) {
        ...
        unitRow(
                ...
                "Distance",
                DistanceUnit.values(),
                settings.unitProfile().distanceUnit,
        ...
        unitRow(
                ...
                "Speed",
                SpeedUnit.values(),
                settings.unitProfile().speedUnit,
        ...
        unitRow(
                ...
                "Depth",
                DepthUnit.values(),
                settings.unitProfile().depthUnit,
        ...
        unitRow(
                ...
                settings.unitProfile().temperatureUnit,
                settings.unitProfile().temperatureUnitDecimals);

        var latLong = new Label("Lat/Long");
        var latLongCombo =
                resizeable(comboBox(LatLongFormat.values(), settings.unitProfile().latLongFormat));
