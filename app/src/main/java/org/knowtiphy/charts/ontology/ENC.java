...
public class ENC {
	...
	public static double encScale(MapViewModel map) throws TransformException, FactoryException {
		var meters = Coordinates.distanceAcross(map);
		return encScaleKM(meters / 1000);
	}

	public static String encScaleText(MapViewModel map) throws TransformException, FactoryException {
