 ...
 */
public class CanvasShapeMapSkin<F> extends ShapeMapBaseSkin<F> {
    ...
    public CanvasShapeMapSkin(
            ShapeMapControl<F> surface, IShapeMapViewModel<F> viewModel, Color background) {
        super(surface);

        this.viewModel = viewModel;
        this.background = background;

        for (IMap<F, ReferencedEnvelope> map : viewModel.maps()) {
    ...
    private void repaint(final double width, final double height) {
        ...
        //            overallWts.apply(
        //                    viewModel.viewPortBounds().getMinX(),
        // viewModel.viewPortBounds().getMaxY());
        ...
        //                        renderer.paint();
        //                        //      ((BorderPane)
        // root.getChildren().get(which)).setCenter(canvas);
        //                        which++;
        //                    } catch (Exception ex) {
        //                        ex.printStackTrace();
        //                    }
        ...
        //                    //          var wts =
        // RendererUtilities.worldToScreenTransform(envelope,
