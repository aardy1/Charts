...
public class CoordinateGrid extends Pane {
    ...
    private void latitudeLines(Transformation transform, List<Node> lines, List<Node> labels) {
        var extent = chart.viewPortBounds();
        var screenArea = chart.viewPortScreenArea();
    ...
    private double getScaleDistance(ReferencedEnvelope bounds, double delta)
