...
public class IconSurface extends Pane {
    ...
    //
    //    public IconSurface(ChartViewModel chart, MapDisplayOptions displayOptions) {
    //        this.chart = chart;
    ...
    //                    List.of(AT_OBJNAM),
    //                    "Offshore Platform",
    //                    displayOptions.showPlatformEvents);
    ...
    //                var g = glyph.get();
    //                g.setFontSize(14);
    //                createIcon(feature, g, attributes, defaultValue, visibilityEvents);
    //            }
    ...
    //    }
    //
    //    private static void repositionPoint(
    //            Transformation transformation, Geometry point, Region region) {
