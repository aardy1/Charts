...
public class MapDisplayOptions {
    ...
    public final EventStream<Change<Boolean>> showPlatformEvents =
            EventStreams.changesOf(showPlatforms);

    public final EventStream<Change<Boolean>> showSoundingsEvents =
            EventStreams.changesOf(showSoundings);

    public final EventStream<Change<Boolean>> showGridEvents =
            EventStreams.changesOf(showGridProperty);
    ...
    public MapDisplayOptions() throws IntrospectionException {
        ...
        var gridDescriptor =
                new PropertyDescriptor(
                        "Show Grid", MapDisplayOptions.class, "getShowGrid", "setShowGrid");
