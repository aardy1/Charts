...
public class Test extends Application {
	...
	static Coordinate[] exteriorCoords = new Coordinate[] { new Coordinate(400, 500), //
			new Coordinate(100, 400), new Coordinate(200, 200), new Coordinate(300, 100), //
			new Coordinate(500, 300), new Coordinate(400, 500) };

	static Coordinate[] hole1 = new Coordinate[] { new Coordinate(300, 300), //
			new Coordinate(350, 350), new Coordinate(400, 299), new Coordinate(300, 300) };

	static Coordinate[] hole2 = new Coordinate[] { new Coordinate(150, 375), //
			new Coordinate(250, 375), new Coordinate(250, 350), new Coordinate(150, 350), new Coordinate(150, 375) };

	static Coordinate[] hole3 = new Coordinate[] { new Coordinate(330, 400), //
			new Coordinate(350, 400), new Coordinate(350, 360), new Coordinate(330, 370), new Coordinate(330, 400) };

	/**
	 * GeoTools Quickstart demo application. Prompts the user for a shapefile and displays
	 * its contents on the screen in a map frame
	 */
