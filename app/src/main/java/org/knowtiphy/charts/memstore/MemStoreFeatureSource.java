...
public class MemStoreFeatureSource extends ContentFeatureSource {
	...
	public MemStoreFeatureSource(ContentEntry entry, Query query, ENCChart map, SimpleFeatureType featureType,
	...
	protected ReferencedEnvelope getBoundsInternal(Query query) throws IOException {
		return !(query instanceof MemStoreQuery) ? map.viewPortBounds() : ((MemStoreQuery) query).bounds();
	}
