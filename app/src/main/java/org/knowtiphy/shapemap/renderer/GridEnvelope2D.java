...
/**
 * Defines a range of two-dimensional grid coverage coordinates. This implementation
 * extends {@link Rectangle} for interoperability with Java2D. Note that at the opposite
 * of {@link GeneralGridEnvelope}, this class is mutable.
 *
 * <p>
 * <b>CAUTION:</b> ISO 19123 defines {@linkplain #getHigh high} coordinates as
 * <strong>inclusive</strong>. We follow this specification for all getters methods, but
 * keep in mind that this is the opposite of Java2D usage where {@link Rectangle} maximal
