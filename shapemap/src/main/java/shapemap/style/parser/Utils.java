...
import static shapemap.style.parser.StyleSyntaxException.unknownValueFor;
...
public class Utils {
	...
	public static String parseFontFamily(XMLEvent nextEvent) throws StyleSyntaxException {
		return parseString(nextEvent);
	}

	public static int parseFontSize(XMLEvent nextEvent) throws StyleSyntaxException {
