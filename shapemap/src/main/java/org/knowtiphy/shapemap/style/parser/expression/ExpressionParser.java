...
public class ExpressionParser
{
      ...
      if(nextEvent.isEndElement())
      {
        ...
        switch(tag)
        {
          ...
          case org.knowtiphy.shapemap.style.parser.XML.IS_LIKE -> push(stack, mkBop(endFrame(stack),
            (l, r) -> (feature, geom) -> Operators.like(l, r, feature, geom)));
          case org.knowtiphy.shapemap.style.parser.XML.COALESCE -> push(stack,
            mkBop(endFrame(stack),
  ...
  private static <F> void push(
    LinkedList<LinkedList<IFeatureFunction<F, Object>>> stack, IFeatureFunction<F, Object> function)
  {
  ...
  private static <F> IFeatureFunction<F, Object> mkBop(
    ...
    BiFunction<IFeatureFunction<F, Object>, IFeatureFunction<F, Object>, IFeatureFunction<F,
                                                                                           Object>> operator)
    throws XMLStreamException
  {
